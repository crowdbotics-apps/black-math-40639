"""
Django settings for black_math_40639 project.
...
ROOT_URLCONF = 'black_math_40639.urls'
...
WSGI_APPLICATION = 'black_math_40639.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_math_40639 API",
    "DESCRIPTION": "API documentation for black_math_40639 App",
    "VERSION": "v1",
}
